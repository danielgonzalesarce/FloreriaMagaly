...
// We use import.meta.glob to safely check if the file exists without breaking the build if it's missing
...
if (import.meta.env.DEV) {
  console.log('Firebase initialized with database:', firestoreDatabaseId);
}
